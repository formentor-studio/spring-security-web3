...
public class Web3AuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Web3AuthenticationFilter(AuthenticationManager authenticationManager) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        Web3AuthenticationToken token =
                bearerToken.map(Web3AuthenticationToken::new).orElse(new Web3AuthenticationToken());
    ...
    private Optional<String> deriveBearerTokenFromAuthorizationHeader(HttpServletRequest request) {
        ...
        if (!matcher.matches()) {
            throw new Web3AuthenticationException("Bearer token is malformed");
        }
